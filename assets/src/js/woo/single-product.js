		...
		if ( zoomEnabled ) {
			var zoom_options = $.extend( {
				...
				callback: function() {
					...
					// Load webp for zoom target
					if (zoomImg.src.indexOf('.webp') == -1) { 
						zoomImg.src = zoomImg.src.replace('/wp-content', '/wp-content/webp-express/webp-images').replace('.jpg', '.jpg.webp');
					}
